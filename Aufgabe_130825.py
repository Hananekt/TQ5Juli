# mein_Lieblingsauto = [input (str("geben sie ihr Lieblingsauto ein : "))]
# mein_Lieblingsgetränk = [input (str("geben sie ihr Lieblingsgetränk ein : "))]
# meinen_Lieblingssport = [input (str("geben sie ihren Lieblingssport ein : "))]


mein_Lieblingsauto = " Mercedes "
mein_Lieblingsgetränk = " Kaffee "
meinen_Lieblingssport = " Reiten "
